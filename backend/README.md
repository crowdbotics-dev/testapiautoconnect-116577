...
## Project Structure
    ...
    ├── testapiautoconnect_116577  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_116577`
...
2. Clone this repo and `cd testapiautoconnect_116577`
